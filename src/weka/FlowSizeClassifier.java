...
public class FlowSizeClassifier extends WekaClassifier {
    @Override
    public void execute() throws Exception {
        String dataset = "datasets/100kbfeatures.arff";
        ...
        evaluation.crossValidateModel(classifier, newTrain, 10,
    ...
    public static void main(String []args) {
        ...
        try {
            FlowSizeClassifier test = new FlowSizeClassifier();
            test.execute();
        } catch (Exception e) {
            e.printStackTrace();
