...
public class UDPPacket extends IPPacket implements UDPFields, Serializable
{
    ...
    public String toColoredString(boolean colored) {
        ...
        buffer.append(':');
        buffer.append(getSourcePort() + "(" + IPPort.getName(getSourcePort()) + ")");
        buffer.append(" -> ");
        buffer.append(getDestinationAddress());
        buffer.append(':');
        buffer.append(getDestinationPort() + "(" + IPPort.getName(getDestinationPort()) + ")");
        buffer.append(" l=" + UDP_HEADER_LEN + "," + (getUDPLength()-UDP_HEADER_LEN));
        buffer.append(']');
